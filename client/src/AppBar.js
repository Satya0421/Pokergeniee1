         ...
         <MenuItem><ul className="header-icon" style={{padding:"0px",}}>
{
                                       ...
                                       //                                               </li>
                                          ...
                                          <li className="favorites icon1" style={{}}>
                                            <a className="icon" href="#"  style={{textAlign:"center",}}>
      ...
      .map((search) => {
        return (
          <li key={search._id} className="list-group-item text-capitalize">
            <a href={search.link} style={{textDecoration:"none",color:"#000",fontFamily: "Mulish",
  fontWeight: "700",
  fontSize: "14px",
  lineHeight: "18px",}}>{search.searchTerm}</a>
          </li>
        );
      });
  }
