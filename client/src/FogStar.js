  ...
  <section className="" style={{margin:"0px",padding:"0px auto"}}>
      <div className="container" style={{marginTop:"0px",padding:"0px auto"}}>
        ...
        <div className="productinfo" style={{marginBottom:"20px"}}>
          <h6 className="des" style={{color: "#1da912", fontWeight:"bold",textTransform: "Capitalize"}}></h6>
        </div>
        <p className="productinfo-p" style={{textAlign:"justify"}}>As the name suggests, a thermal fogger uses heat to vaporize a fogging solution. In most cases this liquid is an insecticide. It sprays the solution out of the nozzle of the fogger in the form of a mist or fog. When the fogging solution enters the heating assembly, it goes through a coil that is a very high temperature. This vaporizes the insecticides from its liquid state. This vapour is then sprayed through the nozzle at the end of the foggerin the form of thick fog.</p>
        
        <div className="row we-offer-cover">
          <div className="col-12 col-sm-6 we-offer-item">
            <div className="offer-item-img">
              <img src="img/fogstarcover-1.jpg" alt="img" />
            </div>
          </div>
          <div className="col-12 col-sm-6 we-offer-item">
            <div className="offer-item-img">
              <img src="img/fogstarcover-2.jpg" alt="img" />
            </div>
          </div>
...
//         </div>
 ...
 <section className="techspecs">
    ...
    <tr>
      ...
      <tr>
        <td>Endurance</td>
        <td>15 min (with full payload)</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Fumigant tank capacity </td>
        <td>10 L</td>
      </tr>
       <tr>
        <td>Max fuel consumption  </td>
        <td>700 ml/hr</td>
      </tr>
    </table>
...
//       <div className="container">
//         <h2 style={{color: "#fff"}}>know more about FogStar</h2>
