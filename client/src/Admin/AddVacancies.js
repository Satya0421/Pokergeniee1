...
<div style={{width:"100%"}}>
    <AdminAppbar title={"Add Job Posts"}/>
    </div><br />
<section>
              ...
              <Grid item xs={12} style={{width:"100%",paddingLeft:"4px"}}>
                   ...
                   <div style={{float:"left"}}><span><input className="form-control" type="search" name="enter" id="search" placeholder="Search By Name" value={search}  onChange={(e)=> {setSearch(e.target.value)}}/>
                    <br /><input type="submit"  className="quiry-btn" value="Search" onClick={getposts} ></input></span></div>
                          ...
                          <span  style={{float:"right",marginRight:"25px"}} className="quiry-btn" onClick={() => setShow(true)}>Add Job Posts</span>
                ...
                <thead style={{}}>
                  <tr style={{}}>
                    ...
                    <th scope="col" className="th">Position</th>
                     ...
                     <th scope="col" className="th" style={{textAlign:"center"}}>num</th>
                     <th scope="col" className="th">Date</th>
                    <th scope="col" className="th">Time</th>
                    <th scope="col" className="th">Delete post </th>
                    <th scope="col" className="th">Edit post </th>
...
<Modal
    ...
    <Grid container  rowSpacing={2}>
     <Grid item xs={12} className="card-grid" >
              <Grid  columnSpacing={2}  className="container1">
                <Grid item xs={3} md={3} className="grid-card-label">
                      <label className="label" for="email">State </label></Grid>
                     <Grid item  xs={12} md={12}><select className="grid-card-input" name = "state" defaultValue={state}  style={{width:"100%",color:"black"}} 
                     required><option disabled selected>Select a State</option>
                                        {
                                          states.map((state)=>{
                                           // console.log(state)
    ...
    <Grid item xs={12} className="card-grid" >
              <Grid  columnSpacing={2}  className="container1">
                <Grid item xs={3} md={3} className="grid-card-label">
                      <label className="label" for="email">Department </label></Grid>
                     <Grid item  xs={12} md={12}><select className="grid-card-input" name = "department" defaultValue={department}  style={{width:"100%",color:"black"}} 
                     required><option disabled selected>Select a Department</option>
                                        {
                                          departments.map((departments)=>{
                                            return(
                ...
                <Grid item xs={3} md={3} className="grid-card-label">
                                  <label className="label" for="name">Position </label></Grid>
                    <Grid item xs={12} md={12}><span><input className="grid-input" name="position"  type="text" defaultValue={position} style={{Width:"100%",color:"black"}}  
                     required/></span>
                          </Grid>
                               </Grid>
                                 </Grid>
                ...
                <Grid item xs={3} md={3} className="grid-card-label">
                                  <label className="label" for="name">No. of vacancies </label></Grid>
                    <Grid item xs={12} md={12}><span><input className="grid-input" name="num"  type="text" defaultValue={num} style={{Width:"100%",color:"black"}}  
                     required/></span>
                          </Grid>
                               </Grid>
                                 </Grid>
                ...
                <Grid item xs={3} md={3} className="grid-card-label">
                                  <label className="label" for="name">Qualification </label></Grid>
                    <Grid item xs={12} md={12}><span><textarea className="grid-input" name="qualification" defaultValue={qualification} type="text" style={{Width:"100%",color:"black"}} 
