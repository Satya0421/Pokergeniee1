  ...
  <section className="" style={{margin:"0px",padding:"0px auto"}}>
      <div className="container" style={{marginTop:"0px",padding:"0px auto"}}>
        ...
        <div className="productinfo" style={{marginBottom:"20px"}}>
          <h6 className="des" style={{color: "#1da912",textAlign:"center",fontWeight:"bold"}}>35 Minute Endurance | 1 Kilometere Range | 49 Kg MTOW</h6>
        </div>
        <p className="productinfo-p" style={{textAlign:"justify"}} >MD-16P agricultural drone is a long endurance, hybrid multirotor drone, which works on the petrol. MD-16P drone is equipped with F6000 hybrid power system and high quality flight controller system.</p>        
        
        <div className="row we-offer-cover">
          <div className="col-12 col-sm-6 we-offer-item">
            <div className="offer-item-img">
              <img src="img/MD16P-img-1.jpg" alt="img"  loading="lazy"/>
            </div>
          </div>
          <div className="col-12 col-sm-6 we-offer-item">
            <div className="offer-item-img">
              <img src="img/MD16P-img-2.jpg" alt="img"  loading="lazy"/>
            </div>
          </div>
        </div>
 ...
 <section className="overview">
      <div className="container">
        ...
        <div className="overviewtitle">
          ...
          <p className="" style={{color:"#1da912",textAlign:"center"}}>Hybrid Power System</p>
        </div>
        ...
        <div className="overviewtitle">
          <p className="" style={{color:"#1da912",textAlign:"center"}}><img src='producticons/highly-efficient-spraying-systems.svg'  style={{marginBottom:"10px",width:"8%"}}/><br />
High Efficient Spraying System</p>
        </div>
        <div className="overviewinfo">
