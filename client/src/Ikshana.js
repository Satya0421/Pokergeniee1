  ...
  <section className="" style={{margin:"0px",padding:"0px auto"}}>
      <div className="container" style={{marginTop:"0px",padding:"0px auto"}}>
        ...
        <div className="productinfo" style={{marginBottom:"20px"}}>
          <h6 className="des" style={{color: "#1da912", fontWeight:"bold",textTransform: "Capitalize"}}>An eye in the sky </h6>
        </div>
        <p className="productinfo-p" style={{textAlign:"justify"}}>Ikshana drone is manufactured with a metal matrix composite, airframe arms and landing gears are foldable and equipped with PX4 autopilot system and 2 axis gimbal camera with 1080 pixel live transmission.</p>
...
//         </div>
 ...
 <section className="techspecs">
    ...
    <tr>
      ...
      <tr>
        <td>Folding size</td>
        <td>285x285x175 mm </td>
      </tr>
      <tr>
     
        <td>Propeller</td>
        <td>1552 folding propeller </td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Endurance</td>
        <td>25 min (with full payload)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <div className="overviewtitle">
          <p className="" style={{color:"#1da912",textAlign:"center"}}>Camera Features</p>
        </div>
        <div className="overviewinfo" style={{width:"100%", textAlign: "center",display:"flex",flexWrap:"wrap",alignItems:"center",marginBottom:"0px"}}>
        <div className="" style={{textAlign:"center",minWidth:"auto",margin:"auto",marginBottom:"0px"}}>
            <p className="" style={{textAlign:"justify",marginBottom:"0px"}}>• Working voltage – 5 V<br />
            • Working current – 200 mA<br/>
            • FPS – 25
            </p>
          </div>
...
//       <div className="container">
//         <h2 style={{color: "#fff"}}>know more about Ikshana</h2>
...
export default Ikshana;



// <div style={{textAlign:"justify",border:"solid green 2px",alignSelf: "center"}}>• Working voltage – 5 V 
//           <br />
