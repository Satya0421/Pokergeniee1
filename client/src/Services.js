...
<section className=" mask" style={{padding:"20px",backgroundImage: "url(background-img.png)",backgroundSize:"100% 100%",}}>{
  //backgroundImage:"url(img/bg-4.jpg)"#dce1d7 #f5f5f5
}
      <div className="container">
        <section className="techspecs">
          <div className="container" style={{textAlign:"center"}}>
            <div className="overviewinfo services-overviewinfo" style={{textAlign:"",display:"flex",flexWrap:"wrap",alignItems:"center"}}>
            <div style={{textAlign:"center",minWidth:"auto",margin:"auto"}}><p style={{color:"#fff",textAlign:"justify",color:"#dce1d7"}}>
            ...
            <div className="overviewtitle services-overviewtitle" style={{textAlign:"",display:"flex",flexWrap:"wrap",alignItems:"center"}}>
             <div className="" style={{textAlign:"center",minWidth:"auto",margin:"auto"}}>
              <p   style={{color:"#fff",textAlign:"justify",color:"#dce1d7"}}>Don't worry!
        ...
        <div className="container" style={{width:"100%", textAlign: "center",display:"flex",flexWrap:"wrap",alignItems:"center"}}>
          <div className="servicestitle" style={{textAlign:"center",minWidth:"auto",margin:"auto"}}>
            <p className="" style={{color:"#fff",textAlign:"justify",color:"#dce1d7"}}>1. Fill out the form or call to +91-9591999044<br /><br />
     ...
     <br /> <div className="container">
        ...
        <div className="row we-offer-cover">
          <div className="col-12 col-sm-6 we-offer-item">
            ...
            <div className="offer-item-content" style={{textAlign:"justify",paddingTop:"0px"}}>
              <h4 className="title-line-left service-h4" style={{textAlign:"justify",paddingBottom:"5px",marginBottom:"0px"}}>spray</h4>
          ...
          <div className="col-12 col-sm-6 we-offer-item">
            ...
            <div className="offer-item-content" style={{textAlign:"justify"}}>
              <h4 className="title-line-left service-h4" style={{textAlign:"justify",paddingBottom:"5px",marginBottom:"0px"}}>crop-health monitoring</h4>
...
<section className="we-offer-item" style={{}}>
                    ...
                    <div className="container" style={{}}>
                        <h2  className="font-weight-normal text-7 mt-2 mb-0 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" data-appear-animation-delay="200" style={{animationDelay:"200ms",paddingTop:"0px"}}><strong style={{}} className="font-weight-extra-bold faq-title">Frequently Asked Questions</strong></h2>
...
<section>
      <div className="container" style={{}}>
        <h2 className="videos-title" style={{fontWeight:"500",paddingTop:"4%",}}>Farmers success Stories</h2>
        <Videos_Carousel page={"services"} />
        <div className="container">
            <h2 className="testimonial-heading" style={{paddingTop:"10px"}}>testimonials</h2>
    ...
    > 
      ...
      <Modal.Body>
          ...
          <form  className=""  name="contactform" onSubmit={sendEnquiryDetails}>
            ...
            <input type="tel" name="yourphone" placeholder="Phone"  style={{color:"black",padding:"5px"}} pattern="[0-9]{10}" required title="Please Enter Valid Number"/>
