  ...
  <section className="" style={{margin:"0px",padding:"0px auto"}}>
      <div className="container" style={{marginTop:"0px",padding:"0px auto"}}>
        ...
        <div className="productinfo" style={{marginBottom:"20px"}}>
          <h6 className="des" style={{color: "#1da912", textTransform: "Capitalize",fontWeight:"bold"}}>A heavy payload drone </h6>
        </div>
        <p className="productinfo-p" style={{textAlign:"justify"}}>As the name says Bheem is a heavy payload drone, intended to carry 20 kg payload to make the drone lightweight it is manufactured aluminum and carbon fiber.</p>
...
//         </div>
 ...
 <section className="techspecs">
    ...
    <table id="customers" >
    <tr>
        <td style={{width:"50%"}}>Maximum Takeoff weight (MTOW)</td>
        <td >55 kg</td>
      </tr>
    <tr>
        <td>Range</td>
