...
const TestimonialCarousel = (props) => {
    ...
    const verify = async()=>{
     ...
     await axios
      .get(API+`/testimonials/${props.page}`)
      .then((response) => {
...
<div className="slide-testimonial"  style={{wordWrap: "break-word",height:"100%"}}>
            <div className="testimonial-item" style={{wordWrap: "break-word",height:"100%"}}>
              ...
              <h5 className="name">Texas Hold’em Poker</h5>
              {//<div className="prof">Assistant Cinematographer</div>
          }
              <div className="testimon-content" style={{wordWrap: "break-word"}}>Texas hold ’em (also known as Texas holdem, hold ’em, and holdem) is one of the most popular variants of the card game of poker. … The stages consist of a series of three cards (“the flop”), later an additional single card (“the turn” or “fourth street”), and a final card (“the river” or “fifth street”).</div>
            </div>
          </div>
...
<div className="slide-testimonial" style={{wordWrap: "break-word",height:"100%"}}>
            <div className="testimonial-item" style={{wordWrap: "break-word",height:"100%"}}>
              <img className="lazy" src="img/spade.svg" alt="img" style={{
               ...
               <h5 className="name">Pot Limit Omaha</h5>
              {//<div className="prof">President</div>
          }
              <div className="testimon-content">In poker, “PLO” refers to the game of Pot Limit Omaha, which is the world’s second most popular poker variant behind Hold’em. In Pot Limit Omaha, players are dealt four cards (instead of two in Hold’em).</div><br></br>
            <br></br></div>
          </div>
...
<div className="slide-testimonial" style={{wordWrap: "break-word",height:"100%"}}>
            <div className="testimonial-item" style={{wordWrap: "break-word",height:"100%"}}>
              ...
              <h5 className="name">5 Cards PLO</h5>
              {//<div className="prof">Farmer</div>
          }
              <div className="testimon-content">Pot Limit Omaha 5 is a derivative of Texas Hold’em where each player is dealt five private cards, and must make the best hand possible using two (and only two) of their private cards and three (and only three) of the five community cards which are available to every player.
</div><br></br>
            </div>
          </div>
...
// const TestimonialCarousel_Training = () => {
